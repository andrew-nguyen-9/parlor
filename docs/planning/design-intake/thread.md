...
- [ ] B) A dark bench; knots fade in one at a time as the thread is drawn down from the top edge
...
- [ ] A) The chain rail sits inside a visible embroidery hoop / frame with today's date stitched on it
- [ ] B) A loose "case file" tag tied with thread names the day; the rail floats over the loom
...
- [ ] A) Show every knot as a blank slot so the player feels the full length of the weave ahead
- [ ] B) Show only solved + active knots; the road ahead stays dark until reached
...
- [ ] A) Fully hidden — the "final stitch" theme guess is the first time the theme is named
- [ ] B) A faint watermark / partial motif builds behind the rail as links solve
...
- [ ] A) Just the nameplate ("The Weaver · Seamstress of the Order") + a progress read
- [ ] B) A one-line in-character invitation from the Weaver ("A thread has come loose…")
...
- [ ] B) Tighten to near-exact but ignore case/punctuation/leading "the"
...
- [ ] A) Always show the passing letter on the active knot ("begins with 'R'")
...
- [ ] A) Keep one free retry, then the link unravels to a shown answer
...
- [ ] A) Strictly linear — a chain must be woven in order
...
- [ ] B) Add a middle rung (category / era nudge) between tie and scaffold
- [ ] C) Collapse to a single hint that reveals the tie only
- [ ] Other: __________________________________________
> USER NOTES:

### Q: The "reveal answer" button — how prominent should the giving-up path be?
- [ ] A) Keep it as a quiet microlabel next to the hint
- [ ] B) Hide it until after a hint is spent
...
- [ ] A) Keep all three tiers and their 🟩/🟨/⬛ share squares
...
- [ ] B) Only the letter-scaffold (L2) downgrades; the tie clue (L1) is free
...
- [ ] B) Theme is a full extra square that counts equally
- [ ] C) Getting the theme redeems one missed link
- [ ] Other: __________________________________________
> USER NOTES:

### Q: What does the player see as the headline number at the end?
- [ ] A) "X% woven · N clean · theme found/missed" (current)
- [ ] B) A single stitch-count score out of a possible max
- [ ] C) A named rank ("Master Weaver", "Apprentice") derived from tiers
- [ ] Other: __________________________________________
> USER NOTES:

### Q: What counts as a genuinely *good* Thread result worth sharing?
- [ ] A) All links clean (all 🟩) — a flawless weave
- [ ] B) Chain complete at all, regardless of hints — finishing is the win
- [ ] C) Chain clean AND theme found — the full tapestry
- [ ] Other: __________________________________________
> USER NOTES:
...
- [ ] A) Reaching and naming the theme, however many hints were spent
- [ ] B) Solving every link clean with the theme found
...
- [ ] B) Too many misses (e.g. 3 unraveled links) ends it before the theme
- [ ] C) A per-round budget of reveals; running out ends the weave
- [ ] Other: __________________________________________
> USER NOTES:

### Q: The v4 "completion ceremony" — how big should the tapestry reveal be?
- [ ] A) Cinematic: loom falls silent, threads tighten, tapestry unfolds to show a hidden crest/imagery
...
- [ ] A) A rotating Parlor-lore crest / insignia tied to that day's theme
- [ ] B) An embroidered picture literally depicting the day's master theme
- [ ] C) A fragment of a larger picture that completes across many days
- [ ] Other: __________________________________________
> USER NOTES:

### Q: What is the end-of-round resting state after the reveal?
- [ ] A) The finished tapestry hangs, then gently fades toward "tomorrow's puzzle"
- [ ] B) Stays on screen with the share card and a Threads-of-History card
...
- [ ] A) Auto-advance — the thread weaves down to the next knot and focuses the input
- [ ] B) A beat of animation (needle stitch), then advance on its own (current-ish)
- [ ] C) Player taps "next stitch" to advance deliberately
- [ ] Other: __________________________________________
> USER NOTES:

### Q: How does the closing "final stitch" theme step present itself?
- [ ] A) A distinct panel at the foot of the rail with multiple-choice theme buttons (current)
- [ ] B) A free-text "name the thread" box instead of choices
- [ ] C) The theme choices weave in as the last knot on the same rail
- [ ] Other: __________________________________________
> USER NOTES:

### Q: Daily vs freeplay — what's the retry / replay policy?
- [ ] A) One daily weave, no retries; freeplay archive for extra chains
...
- [ ] A) None — the thread "should never move quickly"; take all the time you want
- [ ] B) A soft elapsed timer shown but never punishing
...
- [ ] C) Skip them — keep the loop tight
- [ ] Other: __________________________________________
> USER NOTES:
...
- [ ] C) No persistence — every day is a fresh identical room
- [ ] Other: __________________________________________
> USER NOTES:
...
- [ ] A) Obscurity of the link answers themselves (trivia depth)
- [ ] B) How tightly the letter-chain constrains (rare passing letters like Q/X)
- [ ] C) How hidden the master theme is behind the individual links
- [ ] Other: __________________________________________
> USER NOTES:

### Q: Should difficulty scale across the week, or stay flat?
- [ ] A) Flat — every daily is roughly the same challenge
- [ ] B) Ramps Mon→Sun (Wordle-style) toward a hard weekend weave
...
- [ ] B) Escalates — later stitches are the toughest, the theme lands hardest
- [ ] C) Easiest first (a gentle on-ramp), spikes in the middle
- [ ] Other: __________________________________________
> USER NOTES:

### Q: Which difficulty knob should the player themselves control, if any?
- [ ] A) None — the daily is the daily, one fixed challenge for everyone
...
- [ ] A) Keep ~5 links — a tight daily
- [ ] B) 6–8 links for a meatier weave
- [ ] C) Variable per day (3 short, up to 8 on hard days)
- [ ] Other: __________________________________________
> USER NOTES:
...
- [ ] A) Continuously weaving in the background: wood creaks, pulleys shift, thread tightens on each solve
...
- [ ] A) Dark walnut + velvet black ground with radiant gold-thread accent (current gold wash direction)
...
- [ ] B) The thread visibly "stitches" with a traveling needle on each solve
- [ ] C) Branching gold threads that preview the connection to the next answer
- [ ] Other: __________________________________________
> USER NOTES:

### Q: What material language do the panels and buttons take on?
- [ ] A) Layered fabric panels, embroidered borders, brass sewing buttons, thread-wrapped edges
- [ ] B) Keep today's clean rounded surfaces, add only subtle stitched accents
- [ ] C) Aged parchment / journal surfaces with ink and wax
- [ ] Other: __________________________________________
> USER NOTES:

### Q: The correct-answer feedback moment — how should a stitch land?
- [ ] A) Gold thread rapidly stitches into place, embroidery blooms, soft gold particles, candlelight brightens
...
- [ ] A) Thread tangles/knots briefly, fabric wrinkles, gold dims, candle flickers — "nothing breaks, the fabric resists"
- [ ] B) Keep today's input shake + wrong sfx only
- [ ] C) The knot visibly frays and the answer thread greys out
- [ ] Other: __________________________________________
> USER NOTES:

### Q: How much of the v4 environmental storytelling (letters, mirrors, crests, hidden ink) belongs in-frame?
- [ ] A) Rich — background room details reward observation and evolve over weeks
...
- [ ] A) As embroidered slots — filled letters in gold thread, blanks as empty stitch-holes (current gold direction)
- [ ] B) As a row of loom pegs, letters seated on the warp
...
- [ ] A) Loom goes fully static; thread segments appear instantly, no needle motion (respect current `useReducedMotion` gating)
- [ ] B) Keep gentle opacity fades only, drop all movement/parallax
- [ ] C) A single non-animated "woven" end-state, no transitions at all
- [ ] Other: __________________________________________
> USER NOTES:
...
- [ ] B) Show the empty "not yet spun" state honestly when no real thread exists
...
- [ ] A) Drop the animated loom to a static backdrop; keep the SVG thread rail fully working
- [ ] B) Keep everything but lower particle/shader detail
- [ ] C) Fall back to a plain vertical list of knots with no loom at all
- [ ] Other: __________________________________________
> USER NOTES:

### Q: Weird inputs (empty, whitespace, emoji, very long) in the "name this stitch" box?
- [ ] A) Ignore blank/whitespace (button already disabled), trim the rest, never crash
- [ ] B) Also cap length and strip non-letters before matching
- [ ] C) Accept anything; matching leniency handles it
- [ ] Other: __________________________________________
> USER NOTES:
...
- [ ] B) A "select to copy" fallback highlighting the grid text
- [ ] C) A small toast explaining copy failed
- [ ] Other: __________________________________________
> USER NOTES:

### Q: A chain whose links don't actually pass letters cleanly (data imperfection) — how should the UI behave?
- [ ] A) Suppress the "begins with X" tell for that link, weave on silently (current guard)
...
- [ ] A) Stay fully playable in silence; ambient starts on first interaction if allowed
- [ ] B) Show a small "tap for sound" affordance
- [ ] C) No audio at all unless the player opts in
- [ ] Other: __________________________________________
> USER NOTES:
